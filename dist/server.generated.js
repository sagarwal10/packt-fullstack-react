...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nvar config = {\n  env: \"development\" || false,\n  port: process.env.PORT || 3000,\n  jwtSecret: process.env.JWT_SECRET || \"YOUR_secret_key\",\n  mongoUri: process.env.MONDODB_URI || process.env.MONGO_HOST || 'mongodb://' + (process.env.IP || 'localhost') + ':' + (process.env.MONGO_PORT || '27017') + '/mernproject'\n};\n\nexports.default = config;\n\n//# sourceURL=webpack:///./config/config.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n\nlet errorHandler = {\n  getErrorMessage: function(str) {\n    return str;\n  }\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (errorHandler);\n\n\n//# sourceURL=webpack:///./server/controllers/error.controller?");
...
eval("module.exports = __webpack_require__(/*! /Users/Home/Courses/packt-book-fullstack-react/socialApp/server/server.js */\"./server/server.js\");\n\n\n//# sourceURL=webpack:///multi_./server/server.js?");
